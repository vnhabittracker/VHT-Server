    ...
    <body>
        <section id="container">
            ...
            <header class="header black-bg">
                ...
                <!--logo start-->
                <a href="admin-main.jsp" class="logo"><b>VN <span>Habit</span></b></a>
                <!--logo end-->
                <div class="nav notify-row" id="top_menu">
                    ...
                    <ul class="nav top-menu">
                        ...
                        <li id="header_inbox_bar" class="dropdown">
                            <a data-toggle="dropdown" class="dropdown-toggle" href="admin-main.jsp#">
                            ...
                            <ul class="dropdown-menu extended inbox">
                                ...
                                <li>
                                    <p class="green">Bạn có 5 feedback mới</p>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="admin-main.jsp#">See all messages</a>
                                </li>
                            </ul>
                        </li>
                        <!-- inbox dropdown end -->
                        ...
                        <li id="header_notification_bar" class="dropdown">
                            ...
                            <ul class="dropdown-menu extended notification">
                                ...
                                <li>
                                    <a href="admin-main.jsp#">See all notifications</a>
                                </li>
                            </ul>
                        </li>
                ...
                <div class="top-menu">
                    <ul class="nav pull-right top-menu">
                        <li><a class="logout" href="admin.jsp">Đăng xuất</a></li>
                    </ul>
                </div>
            </header>
            <!--header end-->
            ...
            <aside>
                <div id="sidebar" class="nav-collapse ">
                    ...
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class="mt">
                            <a class="active" href="admin-main.jsp">
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                <li><a href="lobby.jsp">Feed back</a></li>
                            </ul>
                        </li>
                    </ul>
                    <!-- sidebar menu end-->
            ...
            <footer class="site-footer">
                <div class="text-center">
                    <p>
                        &copy; Copyrights <strong>VN Habit Tracker</strong>. All Rights Reserved
                    </p>
                    <div class="credits">
                        <!--
                        ...
                        -->
                        Created with VN Habit Tracker template by <a href="https://templatemag.com/">TemplateMag</a>
                    </div>
                    <a href="admin-main.jsp#" class="go-top">
